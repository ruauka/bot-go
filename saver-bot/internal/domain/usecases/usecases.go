...
func (e *event) MainMenuHandle(update *tg.Update, stateMap map[int64]*State) {
	stateMap[update.Message.From.ID] = new(State)
	stateMap[update.Message.From.ID].State = StateDate
